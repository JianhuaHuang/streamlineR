...
rm(list = ls())
sapply(c('XLConnect', 'dplyr', 'caret', 'glmnet', 'e1071', 'knitr', 'zoo', 
  'reshape2', 'car', 'ggrepel', 'manipulate', 'smbinning', 'rattle', 'corrplot',
  'gWidgets', 'lubridate', 'MASS', 'woe', 'rpart', 'pROC', 'scales', 'stringr',
  'readxl', 'data.table', 'bit64', 'survivalROC', 'survAUC', 
  'randomForestSRC', 'risksetROC', 'gridExtra'), 
